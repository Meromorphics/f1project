...
sample_file_name = f"year{year}_driver_constructor_model_sample_csvs"
...
matplotlib.pyplot.title("Driver actual skill", fontsize=26)
matplotlib.pyplot.tight_layout()
#matplotlib.pyplot.show()
matplotlib.pyplot.savefig("actual_driver_skills_with_errorbars.png")
...
matplotlib.pyplot.xticks(range(len(constructor_rankings_df["Mean"])), ["Redbull", "Mercedes", "Aston Martin", "Ferrari", "Mclaren", "Alpine", "Alpha Tauri", "Alfa Romeo", "Williams", "Haas"], rotation=45, ha="center")
# constructor_rankings_df["Mean"].index
matplotlib.pyplot.tick_params(axis="both", labelsize=20, width=2, size=10)
matplotlib.pyplot.title("Constructor skill", fontsize=26)
matplotlib.pyplot.tight_layout()
#matplotlib.pyplot.show()
matplotlib.pyplot.savefig("constructor_skills_with_errorbars.png")
...
matplotlib.pyplot.tick_params(axis="both", labelsize=20, width=2, size=10)
matplotlib.pyplot.title("Driver total skill", fontsize=26)

matplotlib.pyplot.tight_layout()

#matplotlib.pyplot.show()
matplotlib.pyplot.savefig("total_driver_skills_with_errorbars.png")
...
figure = matplotlib.pyplot.figure(figsize=(9,6))
axis = figure.add_subplot(111)
axis.errorbar(x=range(len(driver_rankings_df["Mean"])), y=driver_rankings_df["Mean"], yerr=driver_rankings_df["SD"], fmt="o", capsize=12, color="red", ecolor="red", linewidth=0.5, label="Driver")
matplotlib.pyplot.xticks(range(len(driver_rankings_df["Mean"])), driver_rankings_df["Mean"].index, rotation=45, ha="center")
matplotlib.pyplot.tick_params(axis="both", labelsize=20, width=2, size=10)

axis.errorbar(x=range(len(driver_rankings_df["TotalMean"])), y=driver_rankings_df["TotalMean"], yerr=driver_rankings_df["TotalSD"], fmt="o", capsize=12, color="navy", ecolor="navy", linewidth=0.5, label="Driver + constructor")
matplotlib.pyplot.xticks(range(len(driver_rankings_df["TotalMean"])), driver_rankings_df["TotalMean"].index, rotation=45, ha="center")
matplotlib.pyplot.tick_params(axis="both", labelsize=16, width=2, size=10)
matplotlib.pyplot.legend(prop={"size":  18})
matplotlib.pyplot.title("Driver skill with/without constructor", fontsize=20)
matplotlib.pyplot.tight_layout()
#matplotlib.pyplot.show()
matplotlib.pyplot.savefig("before_after_driver_skills_with_errorbars.png")
...
matplotlib.pyplot.tight_layout()
#matplotlib.pyplot.show()
matplotlib.pyplot.savefig("before_after_driver_skills_with_no_errorbars.png")
